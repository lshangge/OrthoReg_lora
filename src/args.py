...
def parse_arguments():
    ...
    parser.add_argument(
        "--data-location",
        type=str,
        default=os.path.expanduser("/path/to/datasets"),
    ...
    parser.add_argument(
        "--finetuning-mode",
        choices=["none", "loraatt", "loraatt_ortho"],
        help="Finetuning mode: loraatt (LoRA-ATT baseline) or loraatt_ortho (LoRA-ATT + OrthoReg).",
    )
    parser.add_argument(
        "--n-eval-points",
        type=int,
